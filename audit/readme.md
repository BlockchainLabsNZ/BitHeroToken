...
- The MultiSigWallet contract is using a different name, GnosisWallet.sol, as the file name. It doesn’t break the contract’s behaviour or connections. However, we don't recommand this. Naming the file by contract name is better for readbility.
